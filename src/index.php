    ...
    <?php foreach ($result as $player) { ?>
        <div class="card shadow-lg">
            ...
            <div class="card-body d-flex flex-column">
                ...
                <p class="card-text">
                    Country:
                    <img height=25 width=30 src="assets/img/flags/<?= $player['countryCode'] ?>.svg" alt="Flag of <?= $player['country'] ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="<?= $player['country'] ?>">
                </p>
                <a href="/viewPlayer.php?id=<?= $player['uuid'] ?>" class="btn btn-success align-self-end">
